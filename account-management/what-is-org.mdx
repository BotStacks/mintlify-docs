...
The organization is the central hub for all activities related to billing, subscription management, and overall account administration. It serves as the umbrella under which all other elements of your BotStacks usage reside.
...
While an organization encompasses multiple workspaces, it provides a centralized point of access for managing and overseeing all associated botstacks, users and resources.