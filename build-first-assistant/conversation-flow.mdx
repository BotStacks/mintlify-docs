...
Now that you've already created a BotStack and added your data to the knowledge base, let's build a simple assistant using the nodes and connections.


In the AI Assistant Designer, you will find the Node Stack on the left side. This section contains all the nodes available for building your AI Assistant. Each node has its own specific purpose, and you can learn more about them by clicking [here](/designer/nodes).

<img 
height="500"  
src="/images/build-first-assistant/node-stack.png"
/>
...
You can copy the settings on LLM Node from the image above. If you want to know more about how the LLM node works, click [here](/designer/nodes/llm).
