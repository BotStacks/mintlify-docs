...
Additionally, conditional paths allow you to route to alternate paths or flows within your conversation

<Tip>
Example:
**If** user sent x messages, **then** ask for contact details.
</Tip>
...
1. **Select a Variable:** Choose a variable from your variables list
