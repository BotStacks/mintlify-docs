...
\~ **New:** Baked-in "user\_id" variable in canvas (mostly useful for api integrations)
...
\~ **New:** Baked in last\_kb\_response\_sources variable

* allowing access to reserved/baked-in variables such as chat\_history, botstack\_last\_utterance, and last\_kb\_response\_sources
