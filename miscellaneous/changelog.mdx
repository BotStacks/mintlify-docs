...
~ **Fixes:** Multiple fixes and UX improvements for the Sequence Studio, DIRTBox and BrainVault.

~ **New: **System Prompt Templates for the LLM node\!
...
- Updated Models\!
  OpenAI : GPT-4.5, o3-mini, o1, o1 mini
  Anthropic: Claude 3.7 Sonnet with extended thinking mode. Claude 3.5 Sonnet v2\
  DeepSeek: V3, R1
  Google: Gemini 2.0 Flash, Gemini 2.0 Flash-Lite, Gemini 2.0 Flash Thinking
- Crisp Integration Enhancements\! documentation coming soon.

## 2.5.0

<sup>Mar 4, 2025</sup>

~ **New:**  DIRTBox Revisions\! revise your assistant's answers when they are wrong or need to be improved.

## 2.4.0

<sup>Feb 25, 2025</sup>

~ **Bug Fix:** Properly handling agent usage limit.

~ **New:**  Capture User Data Node. Used to collect user information to send to the API node.
...
<sup>Sept 23, 2024</sup>

~ **Fixes:** Multiple fixes and UX improvements for the Sequence Studio.

## 2.2.0

<sup>Sept 20, 2024</sup>
...
~ **New:** Multimodal (usable from the sandbox, web-chat, and api)
...
~ **New:** Use wildcards in web-chat whitelist setting (you can now allow your entire site with a single address like https://botstacks.ai/\\\\\\\\\\\\\\\*)

~ **Improvement:** Improved layout of BYOM (bring your own model) llm panel
...
~ **Bug Fix:** Fixed panel scroll-ability
...
~ **Bug Fix:** New account registration emails not sending
