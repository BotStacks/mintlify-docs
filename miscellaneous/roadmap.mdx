...
<CardGroup cols={1}>
  <Card title="Integration Marketplace" icon="Sparkle">
  ...
  <Card title="Custom Datbase Integration" icon="Sparkle">
...
<Card title="Have an Idea?" icon="lightbulb" color="orange" href="https://discord.gg/eXV43sfDkb">
  We'd love to hear it. Join our discord server and let us know!

  [Click here](https://discord.com/invite/5kwyQCz3zZ) to join!
</Card>