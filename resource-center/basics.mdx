...
sidebarTitle: "Basics"
description: "This section serves as your entry point into the world of conversational AI. Below, you'll find essential information to help you understand the core concepts and components involved in the creation of chat bots and AI assistants."
icon: "meteor"
iconType: "solid"
---
...
Conversational AI refers to the technology that enables machines to engage users in natural language dialogues. By utilizing techniques from natural language processing (NLP) and machine learning, conversational AI systems can understand user inputs, generate suitable responses and provide intelligent assistance.
...
<CardGroup cols={3}>
  ...
  <Card title="OpenAI Chat-GPT" icon="sparkle">
  </Card>
...
<AccordionGroup>
  ...
  <Accordion title="Do I need coding experience to use Botstacks?">
    ...
    However, familiarity with basic programming concepts may help users take full advantage of the platform's extensive capabilities.
  </Accordion>
  ...
  <Accordion title="Can I build AI assistants for specific platforms like Facebook Messenger, WhatsApp or Slack using Botstacks?">
    Yes, Botstacks allows you to build AI assistants for specific platforms like Facebook Messenger, WhatsApp, Slack, Discord, and more. 
  ...
  <Accordion title="Can I use Botstacks to create AI assistants in multiple languages?">
    ...
    You can design and deploy assistants that can communicate with users in their native language, allowing you to reach a global audience, grow your brand, and increase your reach and revenue.
  </Accordion>
