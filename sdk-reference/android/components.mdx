...
- [Avatar](https://docs.botstacks.ai/sdk-reference/android/components#avatar)
- [Badge](https://docs.botstacks.ai/sdk-reference/android/components#badge)
- [ChannelGroup](https://docs.botstacks.ai/sdk-reference/android/components#channelgroup)
- [ChannelRow](https://docs.botstacks.ai/sdk-reference/android/components#channelrow)
- [ChatInput](https://docs.botstacks.ai/sdk-reference/android/components#chatinput)
- [ChatList](https://docs.botstacks.ai/sdk-reference/android/components#chatlist)
- [ChatMessage](https://docs.botstacks.ai/sdk-reference/android/components#chatmessage)
- [ChatMessagePreview](https://docs.botstacks.ai/sdk-reference/android/components#chatmessagepreview)
- [Header](https://docs.botstacks.ai/sdk-reference/android/components#header)
- [MediaActionSheet](https://docs.botstacks.ai/sdk-reference/android/components#mediaactionsheet)
- [MessageActionSheet](https://docs.botstacks.ai/sdk-reference/android/components#messageactionsheet)
- [MessageList](https://docs.botstacks.ai/sdk-reference/android/components#messagelist)
- [Spinner](https://docs.botstacks.ai/sdk-reference/android/components#spinner)
- [UserProfile](https://docs.botstacks.ai/sdk-reference/android/components#userprofile)
- [UserSelect](https://docs.botstacks.ai/sdk-reference/android/components#userselect)
...
/>
Our Badge component renders a "badge" that can either take in a `Int` count or a `String` label. This is utilized in the [MessageList](https://docs.botstacks.ai/sdk-reference/android/components#messagelist) component serving as the date separators, in the [ChatList](https://docs.botstacks.ai/sdk-reference/android/components#chatlist) component to show unread counts, and in the [ChannelSettingsView](https://docs.botstacks.ai/sdk-reference/android/views#chatsettingsview) for displaying admins.
...
This is utilized in the [ChannelGroup](https://docs.botstacks.ai/sdk-reference/android/components#channelgroup) within [UserDetailsView](https://docs.botstacks.ai/sdk-reference/android/views#userdetailsview) to show channels the current user has in common with any other user.
...
/>
Text input that handles the sending of messages to a given Chat when the send button is pressed. This is generally used for [MessageList](https://docs.botstacks.ai/sdk-reference/android/components#messagelist) as there is handling for an attachment sheet that will present from the callback `onMedia`.
...
/>
Renders a given list of `Chat` in an infinite scrolling list. Each chat will render a preview of it using [ChatMessagePreview](https://docs.botstacks.ai/sdk-reference/android/components#chatmessagepreview).
...
This is used by [MessageList](https://docs.botstacks.ai/sdk-reference/android/components#messagelist) to form the contents of a conversational chat, by properly aligning messages to left or right depending on sender (left aligned for incoming and right aligned for outgoing).
...
/>
Renders a "preview" for a given chat. This is based on the last message, if any, that was either sent or received in the chat. Attachments will be rendered as well. This is utilized in [ChatList](https://docs.botstacks.ai/sdk-reference/android/components#chatlist) to show previews for all chats that a user is currently a member of.
...
### MessageActionSheet
A modal bottom sheet that allows contextual actions for a given messaged. This is a top level scaffold that is designed to wrap your screen content. This can be utilized in conjunction with [MessageList](https://docs.botstacks.ai/sdk-reference/android/components#messagelist) to show contextual actions for the `MessageList#onLongPress` callback.
...
/>
Renders an [Avatar](https://docs.botstacks.ai/sdk-reference/android/components#avatar) and the display name for a given User in a centered Column.
