...
### MessageActionSheet
A modal bottom sheet that allows contextual actions for a given messaged. This is a top level scaffold that is designed to wrap your screen content. This can be utilized in conjunction with [MessageList](#messagelist) to show contextual actions for the `MessageList#onLongPress` callback.
