...
If you do not yet have an `accessToken`, pass nil. This will create a new user.
You can retrieve the access token via `BotStacksChat.shared.prefs.getString("auth-token", null)`.
