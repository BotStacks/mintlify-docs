---
title: Android Screen Content Views
sidebarTitle: "Views"
---
...
- [ChannelSettingsView](https://docs.botstacks.ai/sdk-reference/android/views#channelsettingsview)
- [CreateChannelView](https://docs.botstacks.ai/sdk-reference/android/views#createchannelview)
- [EditProfileView](https://docs.botstacks.ai/sdk-reference/android/views#editprofileview)
- [SelectChannelUsersView](https://docs.botstacks.ai/sdk-reference/android/views#selectchannelusersview)
- [UserDetailsView](https://docs.botstacks.ai/sdk-reference/android/views#userdetailsview)
...
### CreateChannelView
A screen content view for creating a new Channel. This has a callback to trigger navigation to selecting users for the channel. The UI for this screen can be found in [SelectChannelUsersView](https://docs.botstacks.ai/sdk-reference/android/views#selectchannelusersview).
...
This is used in coordination with either a [CreateChannelView](https://docs.botstacks.ai/sdk-reference/android/views#selectchannelusersview) or a [ChannelSettingsView](https://docs.botstacks.ai/sdk-reference/android/views#channelsettingsview) to set or update the users in a given channel.
