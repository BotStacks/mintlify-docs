...
This is utilized in the [ChannelGroup](#channelgroup) within [UserDetailsView](https://docs.botstacks.ai/sdk-reference/android/views#userdetailsview) to show which channels the current user has in common with any other user.
