...
<CardGroup cols={2}>
  <Card title="A Crisp Account" icon="discord" iconType="solid" href="https://crisp.chat/en/">
  </Card>
...
<img height="500" src="/images/integrations/crisp/image.png"/>
...
Login to your account at <https://crisp.chat/en/> and navigate to Settings -> Workspace Settings -> Setup & Integrations. There you can get the Crisp Website ID and use it on Botstacks.
