...
<CardGroup cols="2">
  <Card title="A Crisp Account" icon="message" iconType="solid" href="https://crisp.chat/en/">
    
  </Card>
  <Card title="Access to Crisp Marketplace" icon="store" iconType="solid" href="https://marketplace.crisp.chat/">
